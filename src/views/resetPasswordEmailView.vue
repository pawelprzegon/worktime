  ...
  <section class="bg-gray-50 dark:bg-primary">
    <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 grid lg:grid-cols-2 gap-8 lg:gap-16">
        <div class="flex flex-col justify-center">
            <h1 class="mb-4 text-4xl font-extrabold tracking-tight leading-none text-gray-900 md:text-5xl lg:text-6xl dark:text-white">{{ t('ressetPasswordEmailView.textHeader') }}</h1>
            <p class="mb-6 text-lg font-normal text-gray-500 lg:text-xl dark:text-gray-400">{{ t('ressetPasswordEmailView.textInfo') }}</p>
            <a href="#" class="text-blue-600 dark:text-blue-500 hover:underline font-medium text-lg inline-flex items-center">{{ t('ressetPasswordEmailView.textMore') }}
        ...
        <div>
            <div class="w-full lg:max-w-xl p-6 space-y-8 sm:p-8 bg-white rounded-lg shadow-xl dark:bg-neutral-900">
                <h2 class="text-2xl font-bold text-neutral-900 dark:text-white">
                    {{ t('ressetPasswordEmailView.header') }}
                </h2>
