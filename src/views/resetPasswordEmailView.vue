  ...
  <section class="bg-gray-50 dark:bg-primary">
    <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 grid lg:grid-cols-2 gap-8 lg:gap-16">
        <div class="flex flex-col justify-center">
            <h1 class="mb-4 text-4xl font-extrabold tracking-tight leading-none text-gray-900 md:text-5xl lg:text-6xl dark:text-white">Reset Your Password</h1>
            <p class="mb-6 text-lg font-normal text-gray-500 lg:text-xl dark:text-gray-400">Enter your email address, and we will send you a link to reset your password. If you don’t receive an email within a few minutes, please check your spam folder or try again.</p>
