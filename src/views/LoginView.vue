        ...
        <div>
            <div class="w-full lg:max-w-xl p-6 space-y-8 sm:p-8 bg-white rounded-lg shadow-xl dark:bg-neutral-900">
                ...
                <form @submit.prevent="handleLogin" class="mt-8 space-y-6" action="#">
                    ...
                    <div>
                        <label for="password" class="block mb-2 text-sm font-medium text-neutral-900 dark:text-white">Your password</label>
                        <input v-model="password" type="password" name="password" id="password" placeholder="••••••••" class="bg-neutral-50 border border-neutral-300 text-neutral-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-neutral-700 dark:border-neutral-600 dark:placeholder-neutral-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" required />
                    </div>
                    <div class="flex items-start">
                        ...
                        <label for="remember" class="font-medium text-neutral-500 dark:text-neutral-400">Remember this device</label>
                        </div>
                        <a @click="redirectGenerateChangePasswordURL" class="ms-auto text-sm font-medium  text-blue-600 hover:underline dark:text-blue-500 hover:cursor-pointer">Lost Password?</a>
                    </div>
                    ...
                    <div class="text-sm font-medium text-neutral-900 dark:text-white">
                        Not registered yet? <a @click="goToSignIn" class="text-blue-600 hover:underline hover:cursor-pointer dark:text-blue-500">Create account</a>
                    </div>
                </form>
            </div>
        </div>
