...
<template>
  ...
  >
    ...
    <DetailsContainer :label="'lastname'" :data="selectedUser.user.username"/>
    ...
    <div class="flex flex-row justify-between">
      ...
      <input v-if="!selectedUser.user.disabled"
             id="default-checkbox"
             type="checkbox"
             value=""
             class="
      ...
      <input
          ...
          type="checkbox"
          value=""
          class="w-4 h-4 my-auto text-blue-600 bg-gray-100 border-gray-300 rounded
          focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800
          focus:ring-2 dark:bg-gray-700 dark:border-gray-600"
      >
    </div>
