...
import ShiftDetails from "@/components/userPanel/modals/ShiftDetails/ShiftDetails.vue";
...
import DeleteShiftConfirm from "@/components/userPanel/modals/ShiftDetails/DeleteShiftConfirm.vue";
