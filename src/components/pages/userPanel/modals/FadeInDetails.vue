...
onMounted(() => {
  isDayOff.value = dayStore.list.filter(s => s.off_type !== null).length > 0
})
const checkOffDay = () => {
...
<template>
  <aside class="flex flex-col fixed top-0 px-4 py-4 h-screen transition-transform duration-300 ease-in-out bg-secondary border-third z-40
                ...
                portrait-small:-right-[400px] portrait-small:w-[400px]
                portrait-medium:-right-[600px] portrait-medium:w-[600px]
                portrait-large:-right-[700px] portrait-large:w-[700px]
    ...
    <div class="ms-auto">
      ...
      />
        ...
        <div class="shifts-label">
          ...
          <h3 class="text-beb font-bold text-2xl">{{getDateString(dayStore.date)}}</h3>
